...
namespace MtX.Nro2Nsp
{
    public partial class SettingsMenu : Form
    {
        ...
        public bool SettingsChecks()
        {
            ...
            ArrayCheck[2] = (RollingIdClick.Checked == true && RollingIdBox.Text != "" && RollingIdBox.Text.Length == 16) || RollingIdClick.Checked == false ;
            ...
            string[] Errors = {"Custom Devkitpro is enabled but the value is null, please change to a proper path", "Preset Author is enabled but the vaule is null," +
                               " please change to a vaild value", "Rolling TItle Id is enabled but the vaule is invalid, please set to a 16 char hex string"};
